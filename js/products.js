...
const SVEIKERIS = [
  // ── Core Sellers ────────────────────────────────────────────────────────────
  {
    ...
    alt: 'Sveikeris Coconut Strawberry - 50g',
    badges: [{ text: 'Sugar-Free', cls: 'caramel' }],
    title: 'Sveikeris Coconut Strawberry',
    desc: 'A lighter, fruit-forward option with wide appeal. Strawberry and coconut with a soft crunch - built for customers looking for a sweeter profile without added sugar.',
  ...
  },
  {
    ...
    alt: 'Sveikeris Double Choco - 50g',
    badges: [{ text: 'Vegan' }],
  ...
  // ── Protein / Functional ────────────────────────────────────────────────────
  {
    group: 'Protein / Functional',
    imgKey: 'sveik_protein_almond',
    alt: 'Sveikeris Protein Almond - 50g',
    badges: [{ text: 'Protein', cls: 'caramel' }, { text: 'Sugar-Free', cls: 'caramel' }],
    title: 'Sveikeris Protein Almond',
    desc: 'A 15g protein, sugar-free bar with strong everyday appeal. Coconut and almond with a soft bite, coated in rich chocolate.',
    btnLabel: 'View Details',
  ...
  },
  {
    ...
    alt: 'Sveikeris Protein Coconut Strawberry - 50g',
    badges: [{ text: 'Protein', cls: 'caramel' }, { text: 'Strawberry', cls: 'red' }],
  ...
  // ── Chocolate Range ─────────────────────────────────────────────────────────
  {
    group: 'Chocolate Range',
    imgKey: 'sveik_dark_cocoa_crisp',
    alt: 'Sveikeris Dark Choco Cocoa Crisp - 50g',
    badges: [{ text: 'Sugar-Free', cls: 'caramel' }],
  ...
  },
  {
    ...
    alt: 'Sveikeris White Choco Cocoa Crisp - 50g',
    badges: [{ text: 'Sugar-Free', cls: 'caramel' }],
    title: 'Sveikeris White Choco Cocoa Crisp',
    desc: 'A lighter alternative to dark cocoa crisp. Same crunch, smoother profile - built for wider mass appeal.',
    btnLabel: 'View Details',
  ...
  // ── Trend / Specialty ───────────────────────────────────────────────────────
  {
    group: 'Trend / Specialty',
    imgKey: 'sveik_matcha',
    alt: 'Sveikeris Creamy Coconut, Strawberry & Matcha - 50g',
    badges: [{ text: 'Matcha', cls: 'green' }, { text: 'Sugar-Free', cls: 'caramel' }],
...
const SIGNATURE = [
  ...
  },
  {
    ...
    alt: 'Dubai Style Strawberry Kunafa - 50g',
    imgCls: 'product-photo',
  ...
  },
  {
    ...
    desc: 'Compact, clean-label option with strong pistachio demand. Designed for portion-controlled snacking and health-led ranges.',
    btnLabel: 'View Details',
...
const CRUNCH_BITES = [
  {
    imgKey: 'pistachio_oh',
    alt: 'Pistachi-OH! Kunafa Crunch Bites - 75g',
    ...
    ingredients: '<strong>Pistachio nut paste</strong> 22%, milk chocolate 25% (sugar, cocoa butter, <strong>whole milk powder</strong>, cocoa mass, <strong>skimmed milk powder</strong>, emulsifier (sunflower lecithin), flavouring), white chocolate filling 30% (sugar, cocoa butter equivalent (fully hydrogenated palm kernel oil), <strong>whole milk powder</strong>, white chocolate (sugar, cocoa butter, <strong>whole milk powder</strong>, <strong>skimmed milk powder</strong>, emulsifier: rapeseed lecithin, natural vanilla flavouring)), kunafa 17% (<strong>wheat flour</strong>, water, <strong>wheat starch</strong>, salt, emulsifier (<strong>soya lecithin</strong>), refined sunflower oil, preservative (E202)), tahini paste 2% (roasted hulled <strong>sesame seeds</strong>), emulsifier (E476), salt, water.',
    allergens: 'May contain traces of peanuts and other nuts. For allergens, including cereals containing gluten, see ingredients in bold.',
    warning: 'Tartrazine E102 may have an adverse effect on activity and attention in children.',
    nutrition: {
      energy: '2191 kJ / 525 kcal',
      fat: '33.0 g',
      saturates: '19.0 g',
      carbs: '46 g',
      sugars: '32.0 g',
  ...
  {
    imgKey: 'berry_oh',
    alt: 'Berry-OH! Strawberry Kunafa Bites - 75g',
    badges: [{ text: '75g' }, { text: 'Strawberry', cls: 'red' }, { text: 'Resealable' }],
    title: 'Berry-OH! Strawberry Kunafa Bites',
    desc: 'A safer mass-market option. Smooth, sweet, and highly snackable - designed for broad appeal and consistent sales.',
    ean: '4 778000 504427',
    origin: 'EU',
    netWeight: '5×15g (75g)',
    bullets: [
      'Crispy kunafa texture that stands out on first bite.',
      'Sweet strawberry profile built for mass appeal.',
      'Smooth white chocolate coating.',
      'Resealable pouch for convenience and repeat use.',
    ],
    ingredients: 'white chocolate 27% (sugar, cocoa butter, <strong>whole milk powder</strong>, <strong>lactose (<u>milk</u>)</strong>, <strong>skimmed milk powder</strong>, emulsifiers (<strong>lecithins</strong>), natural vanilla flavouring), white chocolate filling 32.5% (sugar, cocoa butter substitute (fully hydrogenated palm kernel oil), <strong>whole milk powder</strong>, emulsifiers (rapeseed lecithin), flavourings), cashew nut cream 23.5%, kunafa 13.4% (<strong>wheat flour</strong>, water, <strong>wheat starch</strong>, salt, emulsifier (<strong>soya lecithin</strong>), refined sunflower oil, preservative (E202)), freeze-dried strawberry powder 3.6%, flavouring.',
    allergens: 'May contain traces of peanuts and other nuts. For allergens, including cereals containing gluten, see ingredients in bold.',
    warning: null,
    nutrition: {
      energy: '2209 kJ / 528 kcal',
      fat: '31.6 g',
      saturates: '18.2 g',
      carbs: '50.5 g',
      sugars: '36.5 g',
